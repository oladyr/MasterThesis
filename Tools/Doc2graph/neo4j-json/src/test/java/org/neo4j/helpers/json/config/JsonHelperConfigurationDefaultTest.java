...
//
//		expect(transaction.findNode(Label.label("JSON_CONFIG"), "configuration", "byNode")).andReturn(null);
//		expect(db.beginTx()).andReturn(transaction);
////		expect(db.findNode(Label.label("JSON_CONFIG"), "configuration", "byNode")).andReturn(null);
////		expect(db.beginTx().findNode(Label.label("JSON_CONFIG"), "configuration", "byNode")).andReturn(null);
//		replay(db,log);
//	}
//
//
