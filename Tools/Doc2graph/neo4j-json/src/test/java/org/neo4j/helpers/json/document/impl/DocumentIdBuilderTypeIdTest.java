...
public class DocumentIdBuilderTypeIdTest {

	DocumentIdBuilderTypeId builder;
	
	@Before
	public void setUp() throws Exception {
		this.builder = new DocumentIdBuilderTypeId();
	}
	...
	public void testBuildId() {
		...
		Assert.assertEquals("id: 12, type: 'artist'", buildId.toCypherFilter());
	}
