...
//
////	    TODO Propozycja jak tworzyc bazę, nie wiem czy działa:
////        DatabaseManagementService managementService = new DatabaseManagementServiceBuilder(new File(System.getProperty("java.io.tmpdir"))).build();
////        managementService.createDatabase("database");
////        db = managementService.database("database");
//
//
