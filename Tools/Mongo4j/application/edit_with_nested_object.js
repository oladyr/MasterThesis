...
const Student = require('./models/student_with_nested_object');
...
async function main() {
    ...
    Student.findOne({ name: "Adam" }).then((result) => {
        ...
        console.log(result);
        result.updateNeo({address: {street: "500 Trout Avenue", city: "Los Angeles", zipCode: "10001"}, score: mongoose.Types.Decimal128("90.9")}).then((result => {
